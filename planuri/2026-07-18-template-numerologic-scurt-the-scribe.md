...
Se creează o pereche reutilizabilă Markdown–HTML cu cheia `scurt`, bazată pe cele 9 capitole din lucrarea `Micu (Ivan) Ana Maria 05.09.1983.md`. Template-ul existent `examen` și lucrarea-sursă rămân nemodificate.
...
- Se folosește structura recomandată „9 capitole + carcasa examen”.
