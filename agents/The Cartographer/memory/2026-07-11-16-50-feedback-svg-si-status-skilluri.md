...
## Rol memorie The Cartographer

The Cartographer se ocupa doar de SVG-uri numerologice. In `memory/` se noteaza feedback-ul acumulat din SVG-urile create sau editate, ca sa fie reutilizat la lucrari viitoare.
...
Skill-uri locale disponibile pentru The Cartographer:
