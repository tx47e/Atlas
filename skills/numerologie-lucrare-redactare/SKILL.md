...
- La Codul Spiritului, afiseaza un paragraf de definitie, pozitia persoanei in tabelul zi-luna `T-017`, interpretarea conversationala a codului si a zonei, tabelul zonelor `T-018`, matricea etapelor `T-019`, interpretarea subetapei, definitia varstei Spiritului, un singur chenar cu varsta la nastere si varsta actuala si o recomandare practica. Nu adauga formula separata pentru Codul Spiritului, explicatia modulo, calculul detaliat al subetapei ori demonstratii narative ale inmultirii; rezultatele validate si tabelele sunt suficiente.
...
- In Concluzii, incepe cu subcapitolul `Harta suprapusa`, o descriere de cel mult 2-3 randuri si SVG-ul autonom generat de The Cartographer. Continua cu `Cariera si bani`, apoi `Iubire si relatii`; daca exista partener declarat, personalizeaza ultimul titlu si interpretarea pentru relatia respectiva. Suprapune ciclurile, lectiile, pinaclurile, Soarta-Destin si anii importanti, dar formuleaza ferestre simbolice, nu predictii fixe.
