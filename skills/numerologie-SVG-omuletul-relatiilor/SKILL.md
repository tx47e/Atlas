...
4. Calculeaza realizarea impreuna prin reducerea sumei vibratiilor interioare. In antetul SVG afiseaza numai rezultatul final, in forma `Realizare impreuna: rezultat`; nu afisa operatia sau traseul de reducere.
...
- In antet, afiseaza numai rezultatele finale pentru `Realizare impreuna` si `De rezolvat impreuna`, fara operatii, module sau trasee de reducere.
