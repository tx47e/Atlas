...
- Nu confunda `N2` cu Destinul: `N2` ramane in CNP-ul astral. Destinul pastreaza reducerea unica (`39 -> 12`), iar numarul de rotiri foloseste cifra de interpretare obtinuta prin reducerea completa (`12 -> 3`).
