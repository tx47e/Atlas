...
def main()->int:
    ...
    d,mo,y=m.groups(); d=d.zfill(2);mo=mo.zfill(2); raw=d+mo+y; n1=sum(map(int,raw));n2=reduce_once(n1);destin=reduce(n1);n3=n1-2*next(int(x) for x in d if x!='0');n4=reduce_once(n3)
