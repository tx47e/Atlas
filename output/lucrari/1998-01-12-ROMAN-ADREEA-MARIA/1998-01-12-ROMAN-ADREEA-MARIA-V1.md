# Lucrare numerologica - Roman Adreea Maria - V1
...
- Persoana analizata: Roman Adreea Maria
- Data nasterii: 12.01.1998
- Nume familie: Roman
- Prenume: Adreea Maria
- Prenume activ folosit in calcul: Adreea
- Versiune lucrare: V1
...
Pentru Roman Adreea Maria, analiza porneste de la doua surse principale: data nasterii si numele complet. Data nasterii arata structura nativa, adica felul in care energia este asezata la baza vietii. Numele arata forma prin care persoana se exprima in lume si felul in care identitatea este chemata sa se manifeste.

Data folosita este 12.01.1998; numele complet folosit este Roman Adreea Maria.
...
Ziua = 12; luna = 1; anul = 1998; data compacta = 12011998; numele complet = Roman Adreea Maria.
...
Formula folosita: reducere(suma reducerilor componentelor numelui). Totalul este 20, iar reducerea este: 2 + 0 = 2; rezultat final 2.
...
Formula folosita: reducere(suma consoanelor). Totalul este 44, iar reducerea este: 4 + 4 = 8; rezultat final 8.
...
In nume apar urmatoarele frecvente principale: cifra 1 apare de 5 ori, cifra 4 de 3 ori, cifra 5 de 3 ori, cifra 6 o data, iar cifra 9 de 4 ori. Cifra intensa este 1. Primele si ultimele litere sunt: Roman incepe cu R=9 si se incheie cu N=5; Adreea incepe cu A=1 si se incheie cu A=1; Maria incepe cu M=4 si se incheie cu A=1. Primele vocale sunt O=6, A=1 si A=1.
...
Pentru o lucrare finala, semnatura poate fi adaugata ca imagine sau anexa, dupa validarea formulei folosite.
...
VI=3; VE=1; VG=4; Calea destinului=31; Destin=4; Numar de exprimare=2.

Pentru Roman Adreea Maria, harta arata un dialog intre energia interioara 3, manifestarea exterioara 1 si destinul 4. Fiecare rezultat trebuie citit in relatie cu celelalte. Unde exista forta, se cere maturitate; unde exista lipsa, se cere educare; unde exista repetitie, se poate forma maiestrie.
