---
titlu: Lucrare numerologică scurtă — Roman Andreea Maria
tip: lucrare-numerologica
template: scurt
status: revizie
versiune: V1.00R
persoana: Roman Andreea Maria
...
<div class="matrix-grid matrix-grid-outlined" data-source-svg="matrita-datei-roman-andreea-maria.svg" aria-label="Matrița numerologică 3 pe 3 pentru Roman Andreea Maria">
<div class="matrix-cell element-foc"><div class="matrix-number">1</div><div class="matrix-main">111111</div><div class="matrix-opt">optim 111</div><div class="matrix-geom" aria-label="hexagramă"><svg viewBox="0 0 40 32" role="img"><polygon points="20,3 35,27 5,27"/><polygon points="20,29 5,5 35,5"/></svg></div></div>
<div class="matrix-cell element-pamant"><div class="matrix-number">4</div><div class="matrix-main">4</div><div class="matrix-opt">optim 44</div><div class="matrix-geom" aria-label="cerc"><svg viewBox="0 0 40 32" role="img"><circle cx="20" cy="16" r="6"/></svg></div></div>
<div class="matrix-cell element-aer"><div class="matrix-number">7</div><div class="matrix-main">-</div><div class="matrix-opt">optim 7</div><div class="matrix-geom matrix-geom-empty" aria-label="absent"></div></div>
...
<div class="matrix-cell element-aer"><div class="matrix-number">3</div><div class="matrix-main">3</div><div class="matrix-opt">optim 333</div><div class="matrix-geom" aria-label="cerc"><svg viewBox="0 0 40 32" role="img"><circle cx="20" cy="16" r="6"/></svg></div></div>
...
<div class="matrix-cell element-foc"><div class="matrix-number">9</div><div class="matrix-main">999</div><div class="matrix-opt">optim 9</div><div class="matrix-geom" aria-label="triunghi"><svg viewBox="0 0 40 32" role="img"><polygon points="20,4 33,27 7,27"/></svg></div></div>
</div>
...
<div class="element-analysis framed-panel"><div class="element-indexes"><span>Index: RAM-19980112-v1.00r-T-012</span><span>Index: RAM-19980112-v1.00r-P-044</span></div><div class="element-chart"><div class="element-bars" role="img" aria-label="Distribuția elementelor: Foc 9, Pământ 2, Aer 1, Apă 2"><div class="element-bar"><div class="element-bar-label"><span>Foc</span><strong>9</strong></div><div class="element-bar-track"><span class="element-bar-fill element-foc" style="width:100.0%"></span></div></div><div class="element-bar"><div class="element-bar-label"><span>Pământ</span><strong>2</strong></div><div class="element-bar-track"><span class="element-bar-fill element-pamant" style="width:22.22%"></span></div></div><div class="element-bar"><div class="element-bar-label"><span>Aer</span><strong>1</strong></div><div class="element-bar-track"><span class="element-bar-fill element-aer" style="width:11.11%"></span></div></div><div class="element-bar"><div class="element-bar-label"><span>Apă</span><strong>2</strong></div><div class="element-bar-track"><span class="element-bar-fill element-apa" style="width:22.22%"></span></div></div></div></div><ul class="element-definitions"><li><strong>Focul</strong> este esența vieții, a duhului și a spiritului care animă și activează.</li><li><strong>Pământul</strong> hrănește și dă formă.</li><li><strong>Aerul</strong> eliberează și stimulează inteligența conceptuală.</li><li><strong>Apa</strong> susține emoțiile, flexibilitatea și acumularea.</li></ul></div>
...
<div class="wellbeing-chart" aria-label="Scara bunăstării">
<div class="wellbeing-row"><span class="wellbeing-label vector-label">Vector 789 — Creativitate</span><span class="wellbeing-track"><span class="wellbeing-fill" style="width:100.0%"></span></span><span class="wellbeing-value">35</span></div>
<div class="wellbeing-row"><span class="wellbeing-label vector-label">Vector 159 — Cariera</span><span class="wellbeing-track"><span class="wellbeing-fill" style="width:94.29%"></span></span><span class="wellbeing-value">33</span></div>
<div class="wellbeing-row"><span class="wellbeing-label vector-label">Vector 369 — Bunastare materiala</span><span class="wellbeing-track"><span class="wellbeing-fill" style="width:85.71%"></span></span><span class="wellbeing-value">30</span></div>
<div class="wellbeing-row"><span class="wellbeing-label"><i class="element-dot element-foc"></i>Căsuța 9</span><span class="wellbeing-track"><span class="wellbeing-fill" style="width:77.14%"></span></span><span class="wellbeing-value">27</span></div>
<div class="wellbeing-row"><span class="wellbeing-label vector-label">Vector 123 — Energie</span><span class="wellbeing-track"><span class="wellbeing-fill" style="width:37.14%"></span></span><span class="wellbeing-value">13</span></div>
<div class="wellbeing-row"><span class="wellbeing-label vector-label">Vector 258 — Social</span><span class="wellbeing-track"><span class="wellbeing-fill" style="width:34.29%"></span></span><span class="wellbeing-value">12</span></div>
<div class="wellbeing-row"><span class="wellbeing-label vector-label">Vector 147 — Spiritualitate</span><span class="wellbeing-track"><span class="wellbeing-fill" style="width:28.57%"></span></span><span class="wellbeing-value">10</span></div>
<div class="wellbeing-row"><span class="wellbeing-label"><i class="element-dot element-pamant"></i>Căsuța 8</span><span class="wellbeing-track"><span class="wellbeing-fill" style="width:22.86%"></span></span><span class="wellbeing-value">8</span></div>
<div class="wellbeing-row"><span class="wellbeing-label"><i class="element-dot element-foc"></i>Căsuța 1</span><span class="wellbeing-track"><span class="wellbeing-fill" style="width:17.14%"></span></span><span class="wellbeing-value">6</span></div>
<div class="wellbeing-row"><span class="wellbeing-label"><i class="element-dot element-apa"></i>Căsuța 2</span><span class="wellbeing-track"><span class="wellbeing-fill" style="width:11.43%"></span></span><span class="wellbeing-value">4</span></div>
<div class="wellbeing-row"><span class="wellbeing-label"><i class="element-dot element-pamant"></i>Căsuța 4</span><span class="wellbeing-track"><span class="wellbeing-fill" style="width:11.43%"></span></span><span class="wellbeing-value">4</span></div>
<div class="wellbeing-row"><span class="wellbeing-label vector-label">Vector 456 — Vointa</span><span class="wellbeing-track"><span class="wellbeing-fill" style="width:11.43%"></span></span><span class="wellbeing-value">4</span></div>
<div class="wellbeing-row"><span class="wellbeing-label"><i class="element-dot element-aer"></i>Căsuța 3</span><span class="wellbeing-track"><span class="wellbeing-fill" style="width:8.57%"></span></span><span class="wellbeing-value">3</span></div>
<div class="wellbeing-row"><span class="wellbeing-label vector-label">Vector 357 — Scopuri</span><span class="wellbeing-track"><span class="wellbeing-fill" style="width:8.57%"></span></span><span class="wellbeing-value">3</span></div>
<div class="wellbeing-row"><span class="wellbeing-label"><i class="element-dot element-foc"></i>Căsuța 5</span><span class="wellbeing-track"><span class="wellbeing-fill" style="width:0.0%"></span></span><span class="wellbeing-value">0</span></div>
<div class="wellbeing-row"><span class="wellbeing-label"><i class="element-dot element-apa"></i>Căsuța 6</span><span class="wellbeing-track"><span class="wellbeing-fill" style="width:0.0%"></span></span><span class="wellbeing-value">0</span></div>
<div class="wellbeing-row"><span class="wellbeing-label"><i class="element-dot element-aer"></i>Căsuța 7</span><span class="wellbeing-track"><span class="wellbeing-fill" style="width:0.0%"></span></span><span class="wellbeing-value">0</span></div>
<div class="wellbeing-legend"><span><i class="element-dot element-foc"></i>Foc</span><span><i class="element-dot element-pamant"></i>Pământ</span><span><i class="element-dot element-apa"></i>Apă</span><span><i class="element-dot element-aer"></i>Aer</span></div>
</div>
...
<div class="matrix-cell element-foc"><div class="matrix-number">data 111111</div><div class="matrix-main">11111</div><div class="matrix-opt">optim 111</div><div class="matrix-geom" aria-label="pentagramă"><svg viewBox="0 0 40 32" role="img"><polygon points="20,3 24,13 35,13 26,20 30,30 20,24 10,30 14,20 5,13 16,13"/></svg></div></div>
<div class="matrix-cell element-pamant"><div class="matrix-number">data 4</div><div class="matrix-main">444</div><div class="matrix-opt">optim 44</div><div class="matrix-geom" aria-label="triunghi"><svg viewBox="0 0 40 32" role="img"><polygon points="20,4 33,27 7,27"/></svg></div></div>
<div class="matrix-cell element-aer"><div class="matrix-number">data -</div><div class="matrix-main">7</div><div class="matrix-opt">optim 7</div><div class="matrix-geom" aria-label="cerc"><svg viewBox="0 0 40 32" role="img"><circle cx="20" cy="16" r="6"/></svg></div></div>
<div class="matrix-cell element-apa"><div class="matrix-number">data 22</div><div class="matrix-main">-</div><div class="matrix-opt">optim 222</div><div class="matrix-geom matrix-geom-empty" aria-label="absent"></div></div>
...
<div class="matrix-cell element-aer"><div class="matrix-number">data 3</div><div class="matrix-main">-</div><div class="matrix-opt">optim 333</div><div class="matrix-geom matrix-geom-empty" aria-label="absent"></div></div>
<div class="matrix-cell element-apa"><div class="matrix-number">data -</div><div class="matrix-main">6</div><div class="matrix-opt">optim 66</div><div class="matrix-geom" aria-label="cerc"><svg viewBox="0 0 40 32" role="img"><circle cx="20" cy="16" r="6"/></svg></div></div>
<div class="matrix-cell element-foc"><div class="matrix-number">data 999</div><div class="matrix-main">9999</div><div class="matrix-opt">optim 9</div><div class="matrix-geom" aria-label="pătrat"><svg viewBox="0 0 40 32" role="img"><rect x="8" y="4" width="24" height="24"/></svg></div></div>
</div>
...
| 12 | <span class="spirit-cell-highlight">41</span> | <span class="spirit-zone-material">39</span> | <span class="spirit-zone-material">37</span> | <span class="spirit-zone-material">35</span> | <span class="spirit-zone-material">33</span> | <span class="spirit-zone-material">31</span> | <span class="spirit-zone-material">29</span> | <span class="spirit-zone-material">27</span> | <span class="spirit-zone-reason">25</span> | <span class="spirit-zone-reason">23</span> | <span class="spirit-zone-reason">21</span> | <span class="spirit-zone-reason">19</span> |
...
| 19 | <span class="spirit-zone-material">34</span> | <span class="spirit-zone-material">32</span> | <span class="spirit-zone-material">30</span> | <span class="spirit-zone-material">28</span> | <span class="spirit-zone-reason">26</span> | <span class="spirit-zone-reason">24</span> | <span class="spirit-zone-reason">22</span> | <span class="spirit-zone-reason">20</span> | <span class="spirit-zone-reason">18</span> | <span class="spirit-zone-reason">16</span> | <span class="spirit-zone-reason">14</span> | <span class="spirit-zone-love">12</span> |
...
![Arcana 12 — Spânzuratul, karma din ziua de naștere](tarot-12-spanzuratul-karma-zilei.jpg)
...
![Arcana 9 — Eremitul. Karma din Calea Destinului 31](tarot-09-eremitul-karma-calea-destinului.jpg)
...
![Grafic Soarta și Destin pentru Roman Andreea Maria](soarta-si-destin-roman-andreea-maria.svg)
...
| 26–30 | 2023 | 2024 | 2025 | <span style="color: #b3261e; font-weight: 700;">2026</span> | 2027 |
...
![Omulețul relațiilor pentru Roman Andreea Maria și Bîrsan Daniel Robert](omulet-relatii-roman-andreea-maria-birsan-daniel-robert.png)
