...
```text
vibratia cosmica fixa = primele doua cifre ale anului nasterii
```

### Pasi de calcul

1. Se preia anul nasterii din [[Datele de intrare|data nasterii]].
2. Se extrag primele doua cifre ale anului.
3. Rezultatul se pastreaza ca valoare fixa.
4. Nu se reduce in calculul standard al proiectului.
...
Se foloseste in capitolul de [[Vibratie Cosmica Totala|vibratie cosmica]] pentru a separa fundalul stabil al anului de partea variabila si de totalul redus.
