---
titlu: Vibratie cosmica variabila
tip: concept
tags:
  - numerologie
  - "#ViCosVar"
...
```text
vibratia cosmica variabila = reducere_numerologica(ultimele doua cifre ale anului nasterii)
```

### Pasi de calcul

1. Se preia anul nasterii.
2. Se extrag ultimele doua cifre ale anului.
3. Se aduna cifrele extrase.
4. Daca rezultatul are doua cifre, se reduce pana la 1-9.
5. Optional, se pastreaza rezultatele intermediare semnificative.
...
```text
1980 -> 80 -> 8 + 0 = 8
1999 -> 99 -> 9 + 9 = 18 -> 1 + 8 = 9
1974 -> 74 -> 7 + 4 = 11 -> 1 + 1 = 2
2001 -> 01 -> 0 + 1 = 1
```
...
- Sursa folosita: ultimele doua cifre ale anului.
...
Se foloseste pentru a descrie partea activa si concreta a anului nasterii inainte de sinteza prin [[Vibratie Cosmica Totala|vibratia cosmica totala]].
